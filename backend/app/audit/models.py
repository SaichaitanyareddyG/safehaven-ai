...
class AuditEventType(str, enum.Enum):
    ...
    PATIENT_ALLERGY_ADDED = "PATIENT_ALLERGY_ADDED"
    PATIENT_ALLERGY_REMOVED = "PATIENT_ALLERGY_REMOVED"
    INSTRUCTION_DICTATED = "INSTRUCTION_DICTATED"
    ...
    PATIENT_TEACH_BACK_NEEDS_ATTENTION = "PATIENT_TEACH_BACK_NEEDS_ATTENTION"
